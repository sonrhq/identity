...
import (
	...
	_ "github.com/sonrhq/identity/module"
	...
	identitymodulev1 "github.com/sonrhq/identity/api/module/v1"
	"github.com/sonrhq/identity/keeper"
)

// ExampleModule is a configurator.ModuleOption that add the identity module to the app config.
var ExampleModule = func() configurator.ModuleOption {
	return func(config *configurator.Config) {
		config.ModuleConfigs[identity.ModuleName] = &appv1alpha1.ModuleConfig{
